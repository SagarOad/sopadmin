...
const EmployeeDeclinedLeave = () => {
  ...
  return (
    <DefaultLayout>
      <Breadcrumb pageName="User Management / Employee Declined Leave" />
                  ...
                  data?.data
                    ...
                    .map((data: User, index: number) => (
                      <TableRow className="bg-light" key={data?.user_id}>
                        ...
                        <TableCell>
                          <MenuItem onClick={handleApproved}>Approve</MenuItem>
                        </TableCell>
                      </TableRow>
                    ))}
              </TableBody>
...
export default EmployeeDeclinedLeave;
